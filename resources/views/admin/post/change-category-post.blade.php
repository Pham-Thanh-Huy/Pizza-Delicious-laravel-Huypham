        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-horizontal" action="{{route('admin.change-category-post')}}" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{$category_post_change -> id}}">
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="simpleinput">Tên danh mục</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="simpleinput" name="name_category_post" value="{{$category_post_change -> name}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control" name="parent_category_post">
                                            ...
                                            @if($category_post_change->parent_id == $item->id)
